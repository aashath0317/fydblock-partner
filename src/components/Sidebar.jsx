...
const Sidebar = () => {
    ...
    return (
        <div className="h-screen w-64 bg-[#050B0D] border-r border-white/10 flex flex-col fixed left-0 top-0 z-50">
            {/* Logo */}
            <div className="p-8">
            ...
            {/* Profile Section */}
            <div className="p-4 border-t border-white/5 bg-[#080D0F]">
                <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 cursor-pointer transition-colors">
                    <div className="w-10 h-10 rounded-full bg-gray-600 overflow-hidden border border-white/10">
                        {/* Use a real image here if you have one, e.g., src="/profile.jpg" */}
